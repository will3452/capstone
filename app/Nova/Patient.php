...
class Patient extends Resource
{
    ...
    {
        return [
            Text::make('Image', fn () => "<img style='width:50px; height:50px; border-radius: 50%;' src='$this->picture' />")
                ->asHtml(),
            ...
            HasMany::make('Initial Diagnoses', 'diagnoses', UserDiagnosis::class),
            HasMany::make('Final Diagnoses', 'finalDiagnoses'),
        ];
    }
